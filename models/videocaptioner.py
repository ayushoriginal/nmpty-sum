...
from ..layers import TextEncoder, ConditionalDecoder, VideoEncoder
...
class VideoCaptioner(nn.Module):
    ...
    def set_defaults(self):
        self.defaults = {
            ...
            'bidirectional': True,       # Enable bidirectional encoder
            ...
            'bucket_order': None,       #
            'norm_and_scale': False,    # Enables normalisation of the video feature vectors
        }
    ...
    def __init__(self, opts):
        ...
        if 'enc_dim' in self.opts.model:
            if self.opts.model['bidirectional']:
                self.ctx_sizes = {'feats': self.opts.model['enc_dim'] * 2}
            else:
                self.ctx_sizes = {'feats': self.opts.model['enc_dim']}
    ...
    def load_data(self, split, batch_size, mode='train'):
        ...
        dataset = MultimodalDataset(
            ...
            norm_and_scale=self.opts.data['norm_and_scale'])
        return dataset
    ...
    def encode(self, batch, **kwargs):
        ...
        return {'feats': self.enc(batch['feats'])}
