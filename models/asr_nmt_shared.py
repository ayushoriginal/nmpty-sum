...
from ..layers import ConditionalDecoder, TextEncoder
...
# ASRNMT which shares complete decoder instead of keeping the attentions separate


class ASRNMTShared(nn.Module):
    ...
    def setup(self, is_train=True):
        ...
        self.ctx_dim = self.opts.model['sp_enc_dim'] * 2
        ...
        self.dec = ConditionalDecoder(
            ...
            ctx_name='input',
            ctx_size_dict={'input': self.ctx_dim},
    ...
    def encode(self, batch, **kwargs):
        ...
        return {'input': enc(batch[enc_name])}
